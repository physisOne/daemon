package one.physis.daemon.services.projects.warriors;
...
@Service
public class WarriorsDaemonService extends DaemonService<WarriorsWalletService> {

   private final static String project = "warriors";

   public WarriorsDaemonService(@Value("${projects." + project + ".name}") String name,
                                 ...
                                 WarriorsWalletService walletService, //BEWARE OF THIS!
